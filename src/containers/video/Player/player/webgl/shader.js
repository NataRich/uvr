...
module.exports = function Shader(params, gl, fra, ver) {

    //var fragment = fs.readFileSync('./fragment.glsl', 'utf-8');
    this.params = params;
    this.fragmentShader = getShader(fra, 'fragment', gl);
    this.vertexShader = getShader(ver, 'vertex', gl);
